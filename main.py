...
def transform_and_process_data(df):
    ...
    initial_transformer=joblib.load('pipeline/13_06_2022-12_09_53_custom_attribute_object.pkl')
    df=initial_transformer.transform(df)

    transformer=joblib.load('pipeline/13_06_2022-12_09_53_full_transformer.pkl')
    transformed_data=transformer.transform(df)

    model=joblib.load('model/13_06_2022-12_43_17_best_model.pkl')
    predicted_value=model.predict(transformed_data)

    # print('Predicted Value : ', predicted_value)
    
    target_transformer = joblib.load('pipeline/13_06_2022-12_09_53_target_pipeline.pkl')
